...
* [Go](https://marketplace.visualstudio.com/items?itemName=golang.Go)
    ...
    > [gopls](https://github.com/golang/tools/tree/master/gopls) (pronounced: "go please") is the official [language server](https://langserver.org/) for the Go language. Check the [Go for Visual Studio Code](https://github.com/golang/vscode-go/) for further information. For complete gopls Settings, please [check here](https://github.com/golang/tools/blob/master/gopls/doc/settings.md).
